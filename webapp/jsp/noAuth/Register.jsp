							...
							<div class="form-group ">
								...
								<div class="input-group ">
									...
									<input type="text" class="form-control" name="username"
										id="username" onblur="check()" placeholder="account">
								</div>
							...
							<div class="form-group ">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="password"
										id="password" onblur="checkPassword()" placeholder="password">
								</div>
							...
							<div class="form-group ">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="email"
										   id="email" placeholder="bookstore@gmail.com">
								</div>
								<font color="red"><span id="prompt_email"></span></font>
							</div>
						</form>
						<div class="form-group " style="padding-left: 30%">
							<button class="btn btn-primary" onclick="return checkform()"
								id="sub">submit</button>
							<a type="button" class="btn btn-default" href="Welcome.jsp">Return</a>
						</div>
					</div>
				</div><!--面板内容结束-->
			</div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a type="button" class="btn btn-primary" role="button" href="../normalPage/Center.jsp">进入大厅</a>
		      </div>
		    </div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
		</div><!-- /.modal -->
