...
<html>
	...
	<body>
		...
		<div id="background" style="position:absolute;height:100%;width:100%;z-index:-1;padding:0px;">    
			<img src="../resource/image/C.C1.jpg" height="100%" width="100%"/>
		</div>
					...
					<form class="form-horizontal" id="info-form" method="post">
						...
						<div class="form-group">
							<div class="col-lg-2 col-lg-offset-3 col-md-2 col-md-offset-3 col-sm-2 col-sm-offset-3 col-xs-2 col-xs-offset-3">
								<input type="button" class="btn btn-success" value="Sign in" id="login-button" onclick="login()"/>
							</div>
							<div class="col-lg-2 col-lg-offset-2 col-md-2 col-md-offset-3 col-sm-2 col-sm-offset-3 col-xs-2 col-xs-offset-2">
								<a type="button" class="btn btn-default" href="Register.jsp">Register</a>
							</div>
						</div>
					</form>
				</div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <a id="entry" type="button" class="btn btn-primary" role="button" href="../normalPage/Center.jsp">进入大厅</a>
		      </div>
		    </div><!-- /.modal-content -->
		  </div><!-- /.modal-dialog -->
		</div><!-- /.modal -->
