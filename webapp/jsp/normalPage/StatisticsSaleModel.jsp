...
<html>
	<head>
		...
		<link href="http://cdn.bootcss.com/bootstrap-datetimepicker/4.17.37/css/bootstrap-datetimepicker.css" rel="stylesheet">
		<script type="text/javascript" src="../dict/js/bootstrap-datetimepicker.js"></script>
	</head>
		...
		<div class="container">
			...
			<div class="container">
		        ...
		        <footer>
		            <div class="row">
		                <div class="col-lg-12">
		                    <p align="center">Copyright &copy; Bookstore 2016</p>
		                </div>
		            </div>
		        </footer>
		    </div>
